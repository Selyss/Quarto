public class Piece {
    ...
    public boolean isBlack() { return (attributes & 0b1000) == 0; }  // 1st bit: 1 = white, 0 = black
    public boolean isTall() { return (attributes & 0b0100) != 0; }  // 2nd bit: 1 = tall, 0 = short
    public boolean isRound() { return (attributes & 0b0010) != 0; } // 3rd bit: 1 = round, 0 = square
    public boolean hasHole() { return (attributes & 0b0001) != 0; } // 4th bit: 1 = hole, 0 = solid

    public String getFormattedPiece() {
        String shape = isRound() ? "o" : "x";
        String size = isTall() ? shape.toUpperCase() : shape.toLowerCase();
        String color = isBlack() ? "\033[30m" : "\033[37m"; // Black or White
